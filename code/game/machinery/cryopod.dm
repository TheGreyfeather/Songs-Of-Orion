...
/obj/machinery/computer/cryopod/attack_hand(mob/user = usr)
	...
	user << browse(HTML_SKELETON_BODY(dat), "window=cryopod_console")
...
/obj/machinery/computer/cryopod/Topic(href, href_list)
	...
	if(href_list["log"])
		...
		user << browse(HTML_SKELETON_BODY(dat), "window=cryolog")
	...
	if(href_list["view"])
		...
		user << browse(HTML_SKELETON_BODY(dat), "window=cryoitems")
