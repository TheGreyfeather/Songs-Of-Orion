...
/datum/admin_topic/jobban2/Run(list/input)
	...
	usr << browse(HTML_SKELETON_BODY(dat), "window=jobban2;size=800x490")
...
/datum/admin_topic/c_mode/Run(list/input)
	...
	usr << browse(HTML_SKELETON_BODY(dat), "window=c_mode")
...
/datum/admin_topic/adminfaxview/Run(list/input)
	...
	if (istype(fax, /obj/item/paper))
		...
		usr << browse(HTML_SKELETON_BODY(data), "window=[B.name]")
	else
