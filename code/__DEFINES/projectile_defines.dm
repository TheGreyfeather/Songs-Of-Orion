//Caliber Defines
#define CAL_357 ".357"
#define CAL_CLRIFLE "Caseless"
#define CAL_SRIFLE "Carbine"
#define CAL_PISTOL "Pistol"
#define CAL_LRIFLE "Rifle"
#define CAL_MAGNUM "Magnum"
#define CAL_ANTIM "Anti Material"
